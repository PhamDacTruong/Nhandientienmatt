...
raw_folder = "data/" #Khai báo folder chứa dữ liệu hình ảnh
...
print(X_train.shape)
print(y_train.shape)
def get_model(): #Tạo cấu trúc mảng CNN
...
vggmodel.save("vggmodel.h5")#Chỉ cần save lần chạy đầu tiên
